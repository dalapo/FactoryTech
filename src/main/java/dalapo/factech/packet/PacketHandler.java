...
//		registerMessage(WrenchPacket.Handler.class, WrenchPacket.class, Side.SERVER);
		...
		registerMessage(SwitchTogglePacket.Handler.class, SwitchTogglePacket.class, Side.SERVER);
		registerMessage(FluidTankEmptyPacket.Handler.class, FluidTankEmptyPacket.class, Side.SERVER);
