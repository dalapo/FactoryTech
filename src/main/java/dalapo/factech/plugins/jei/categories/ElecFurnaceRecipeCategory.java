...
public class ElecFurnaceRecipeCategory extends BaseRecipeCategory<StandardRecipeWrapper> {
	...
	public static void register(IRecipeCategoryRegistration registry)
	{
		...
		registry.addRecipeCategories(new ElecFurnaceRecipeCategory(guiHelper));
	}
