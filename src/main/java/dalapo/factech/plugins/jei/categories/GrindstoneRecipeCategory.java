...
public class GrindstoneRecipeCategory extends BaseRecipeCategory<StandardRecipeWrapper> {
	...
	public static void register(IRecipeCategoryRegistration registry)
	{
		...
		registry.addRecipeCategories(new GrindstoneRecipeCategory(guiHelper));
	}
...
//		registry.addRecipeCatalyst(BlockRegistry.saw, "saw");
	...
	public static List<StandardRecipeWrapper> getRecipes(IGuiHelper guiHelper)
	{
		...
		for (MachineRecipe<ItemStack, ItemStack> entry : MachineRecipes.GRINDSTONE)
		{
