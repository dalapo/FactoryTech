...
import static dalapo.factech.config.FacTechConfigManager.*;
...
public class OreGenerator implements IWorldGenerator {
	...
	public OreGenerator()
	{
		if (FacTechConfigManager.genCopper) ores.add(new OreGen("copper", BlockRegistry.ore.getDefaultState().withProperty(StateList.oretype, EnumOreType.COPPER), copperMin, copperMax, Blocks.STONE, 8, 9, 65));
		if (FacTechConfigManager.genNickel) ores.add(new OreGen("nickel", BlockRegistry.ore.getDefaultState().withProperty(StateList.oretype, EnumOreType.NICKEL), nickelMin, nickelMax, Blocks.STONE, 8, 8, 60));
	}
