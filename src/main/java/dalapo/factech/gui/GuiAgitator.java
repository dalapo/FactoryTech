...
public class GuiAgitator extends GuiBasicMachine {
	...
	public void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		addWidget(new WidgetFluidTank(this, 8, 66, 16, 48, agitator.getTank(0), 0));
		addWidget(new WidgetFluidTank(this, 26, 66, 16, 48, agitator.getTank(1), 1));
		addWidget(new WidgetFluidTank(this, 80, 66, 16, 48, agitator.getTank(2), 2));
	}
}