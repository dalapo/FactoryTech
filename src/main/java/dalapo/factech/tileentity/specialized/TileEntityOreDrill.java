...
public class TileEntityOreDrill extends TileEntityBasicProcessor {
	...
	protected void fillMachineParts() {
		partsNeeded[0] = new MachinePart(PartList.MOTOR, 0.1F, 1.1F, 5);
		partsNeeded[1] = new MachinePart(PartList.DRILL, 0.15F, 1.15F, 7);
		partsNeeded[2] = new MachinePart(PartList.WIRE, 0.2F, 1.1F, 5);
	}
