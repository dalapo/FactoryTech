...
public class TileEntityRefrigerator extends TileEntityFluidMachine {
	...
	protected void fillMachineParts() {
		partsNeeded[0] = new MachinePart(PartList.PISTON, 0.2F, 1.15F);
		partsNeeded[1] = new MachinePart(PartList.MOTOR, 0.3F, 1.1F);
		partsNeeded[2] = new MachinePart(PartList.CIRCUIT_2, 0.2F, 1.3F);
	}
