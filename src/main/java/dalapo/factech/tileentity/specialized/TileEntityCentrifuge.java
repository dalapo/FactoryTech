...
public class TileEntityCentrifuge extends TileEntityProcessorMultiOutput {
	...
	protected void fillMachineParts() {
		partsNeeded[0] = new MachinePart(PartList.MOTOR, 0.1F, 1.07F, 0.6F, 2);
		partsNeeded[1] = new MachinePart(PartList.GEAR, 0.2F, 1.1F, 0.5F, 6);
		partsNeeded[2] = new MachinePart(PartList.SHAFT, 0.05F, 1.3F, 16);
	}
