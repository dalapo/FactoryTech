...
public class TileEntityDecoCoil extends TileEntityBase implements ITickable {
	...
	public void update()
	{
		...
		if (!connected && world != null && nbtConnections != null)
		{
			for (BlockPos blockPos : nbtConnections)
			{
				...
				{
					TileEntityDecoCoil.link(this, (TileEntityDecoCoil) world.getTileEntity(blockPos), false);
				}
			}
			connected = true;
		}
	...
	{
		entity.attackEntityFrom(new DamageSource("tesla").setDamageBypassesArmor(), 2);
	}
